...
[phpMyAdmin](http://localhost:13461/)
```

```markdown
# Доступ к wp-admin

Для входа в административную панель WordPress используйте следующие учетные данные:

- Логин: admin
- Пароль: password

## URL для входа
[wp-admin](http://ponomak9.beget.tech/wp-admin/)
[wp-admin](http://localhost:8888/wp-admin)
```

Замените `ваш_логин`, `ваш_пароль` и `ваш_сайт.com` на соответствующие значения. Не забудьте хранить эту информацию в безопасном месте!
