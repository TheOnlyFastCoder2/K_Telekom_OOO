...
add_action('init', function() {
    $asset_url = trailingslashit(get_template_directory_uri()) . 'build/';
    $asset_dir = trailingslashit(get_template_directory()) . 'build/';
    ...
    foreach($asset_files as $asset_file) {
        ...
        $asset_handle = sprintf("app-react/%s", $asset_slug);
...
add_action('wp_enqueue_scripts', function() {
    wp_enqueue_script('app-react/main');
    wp_enqueue_style('app-react/main');
});